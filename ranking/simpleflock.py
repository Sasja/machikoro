...
class SimpleFlock:
   """Provides the simplest possible interface to flock-based file locking. Intended for use with the `with` syntax. It will create/truncate/delete the lock file as necessary. https://github.com/derpston/python-simpleflock

Copyright C 2013 derpston <derpston@sleepygeek.org>
